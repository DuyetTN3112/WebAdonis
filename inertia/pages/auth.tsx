        ...
        {!showLogin ? (
          <div className="bg-custom-black p-6 rounded-lg border border-gray-700 w-[70%]">
            ...
            <form action="/register" method="POST" className="space-y-4">
              <input type="text" name="username" placeholder="Username" className="w-full p-2 rounded bg-custom-darkGray text-white border border-gray-700" />
              <input type="email" name="email" placeholder="Email" className="w-full p-2 rounded bg-custom-darkGray text-white border border-gray-700" />
              ...
              <input type="text" name="phone_number" placeholder="Phone Number (Optional)" className="w-full p-2 rounded bg-custom-darkGray text-white border border-gray-700" />
              <input type="text" name="student_id" placeholder="Student ID (Optional)" className="w-full p-2 rounded bg-custom-darkGray text-white border border-gray-700" />
              {password.length > 0 && (
                <div className="text-white text-sm">
                  Password Strength: <span>{password.length}</span>
                </div>
              )}
              <button type="submit" className="w-full bg-custom-blue text-custom-black p-2 rounded font-bold hover:bg-opacity-90">
                Sign Up!
              </button>
              <div className="text-center text-white">
                Or{' '}
                <button type="button" onClick={() => setShowLogin(true)} className="text-custom-blue hover:underline">
                  Log in
                </button>
              </div>
            </form>
